...
4. Create/Reference a new **branch** and name it `feat/community/YOUR_USERNAME`: `git checkout -b feat/community/monique_c`;
    > Example: `git checkout -b feat/community/moniquesc`
